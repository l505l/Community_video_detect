...
class CLIPVAD(nn.Module):
    ...
    def encode_video(self, images, padding_mask, lengths):
        ...
        # 调试：打印 images 张量的形状
        print(f"Shape of images before permute: {images.shape}")
    
        # 调试：打印 frame_position_embeddings 的形状
        print(f"Shape of frame_position_embeddings: {frame_position_embeddings.shape}")
